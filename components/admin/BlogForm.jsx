  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <input name="title" value={form.title} onChange={handleChange} required className={inputClass} placeholder="Blog title..." />
      </div>
      ...
      <div>
        ...
        <textarea name="excerpt" value={form.excerpt} onChange={handleChange} rows={2} className={inputClass} placeholder="Short description..." />
      </div>
      ...
      <div>
        ...
        <textarea name="content" value={form.content} onChange={handleChange} required rows={12} className={inputClass} placeholder="Write your blog content here..." />
      </div>

      <div>
        <label className={labelClass}>Tags (comma separated)</label>
        <input name="tags" value={form.tags} onChange={handleChange} className={inputClass} placeholder="nextjs, react, web..." />
      </div>
